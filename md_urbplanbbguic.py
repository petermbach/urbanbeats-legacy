...
class UrbplanbbGUILaunch(QtGui.QDialog):
    def __init__(self, activesim, tabindex, parent = None): #activesim, indexnumber, parent = None):
        QtGui.QDialog.__init__(self, parent)
        self.ui = Ui_BuildingBlockDialog()
        self.ui.setupUi(self)
        #self.module = activesim.getParameterSetUrbplanbb(indexnumber)
        ...
        self.ui.demandvary_kitchen_box.setText(str(self.module.getParameter("demandvary_kitchen")))
        self.ui.demandvary_shower_box.setText(str(self.module.getParameter("demandvary_shower")))
        self.ui.demandvary_toilet_box.setText(str(self.module.getParameter("demandvary_toilet")))
        self.ui.demandvary_laundry_box.setText(str(self.module.getParameter("demandvary_laundry")))
    ...
    def save_values(self):
        ...
        self.module.setParameter("locality_mun_trans", int(locality_mun_trans))
        ...
        self.module.setParameter("demandvary_kitchen", float(self.ui.demandvary_kitchen_box.text()))
        self.module.setParameter("demandvary_shower", float(self.ui.demandvary_shower_box.text()))
        self.module.setParameter("demandvary_toilet", float(self.ui.demandvary_toilet_box.text()))
        self.module.setParameter("demandvary_laundry", float(self.ui.demandvary_laundry_box.text()))
        ...
        #--> Landscaping & Drainage
        lscape_hsbalance = float(self.ui.lscape_hsbalance_slide.value())
        self.module.setParameter("lscape_hsbalance", lscape_hsbalance)
        
        lscape_impdced = float(self.ui.lscape_impdced_spin.value())
        ...
        self.module.setParameter("pg_greengrey_ratio", float(self.ui.pg_ggratio_slide.value()))
        ...
        #--> Services & Utilities
        self.module.setParameter("svu_water", float(self.ui.svu_wat_box.text()))
