...
def writeMUSICnodeWSUR(f, ID, nodepart, ncount, x, y, parameter_list, version):
    ...
    f.write("Reuse Properties - Reuse Enabled,"+str(parameter_list[5])+",\n")
    f.write("Reuse Properties - Annual Demand Enabled,"+str(parameter_list[5])+",\n")
    f.write("Reuse Properties - Annual Demand Value (ML/year),"+str(parameter_list[6])+",{ML/year}\n")
    ...
    f.write("Storage Properties - Initial Volume,0,\n")
...
def writeMUSICnodePB(f, ID, nodepart, ncount, x, y, parameter_list, version):
    ...
    f.write("Storage and Infiltration Properties - Initial Volume,0,\n")
