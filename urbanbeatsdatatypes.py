...
def exportBuildingBlocks(filename, assets, miscoptions, map_attr, kmlbool, tech_incl, perf_incl):
    ...
    fielddefmatrix.append(ogr.FieldDefn("LC_REF_CO", ogr.OFTReal))
    fielddefmatrix.append(ogr.FieldDefn("LC_REF_AS", ogr.OFTReal))
    fielddefmatrix.append(ogr.FieldDefn("LC_REF_TR", ogr.OFTReal))
    fielddefmatrix.append(ogr.FieldDefn("LC_SVU_DG", ogr.OFTReal))
    fielddefmatrix.append(ogr.FieldDefn("LC_SVU_IG", ogr.OFTReal))
    ...
    fielddefmatrix.append(ogr.FieldDefn("LC_RD_IG", ogr.OFTReal))
    ...
    if tech_incl == 1:
        ...
        fielddefmatrix.append(ogr.FieldDefn("wd_RES_I", ogr.OFTReal))
        ...
        fielddefmatrix.append(ogr.FieldDefn("wd_HDR_I", ogr.OFTReal))
        ...
        fielddefmatrix.append(ogr.FieldDefn("Blk_Toilet", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("Blk_Laund", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("Blk_Garden", ogr.OFTReal))
    ...
    for i in range(len(assets)):
        ...
        feature.SetField("LC_NA_IG", currentAttList.getAttribute("LC_NA_IG"))
        feature.SetField("LC_NA_CO", currentAttList.getAttribute("LC_NA_CO"))
        feature.SetField("LC_NA_DG", currentAttList.getAttribute("LC_NA_DG"))
        feature.SetField("LC_UND_DG", currentAttList.getAttribute("LC_UND_DG"))
        feature.SetField("LC_UND_IG", currentAttList.getAttribute("LC_UND_IG"))
        feature.SetField("LC_PG_IG", currentAttList.getAttribute("LC_PG_IG"))
        feature.SetField("LC_PG_CO", currentAttList.getAttribute("LC_PG_CO"))
        feature.SetField("LC_PG_AS", currentAttList.getAttribute("LC_PG_AS"))
        feature.SetField("LC_PG_TR", currentAttList.getAttribute("LC_PG_TR"))
        feature.SetField("LC_PG_DG", currentAttList.getAttribute("LC_PG_DG"))
        feature.SetField("LC_REF_DG", currentAttList.getAttribute("LC_REF_DG"))
        feature.SetField("LC_REF_IG", currentAttList.getAttribute("LC_REF_IG"))
        feature.SetField("LC_REF_CO", currentAttList.getAttribute("LC_REF_CO"))
        feature.SetField("LC_REF_AS", currentAttList.getAttribute("LC_REF_AS"))
        feature.SetField("LC_REF_TR", currentAttList.getAttribute("LC_REF_TR"))
        feature.SetField("LC_SVU_DG", currentAttList.getAttribute("LC_SVU_DG"))
        feature.SetField("LC_SVU_IG", currentAttList.getAttribute("LC_SVU_IG"))
        feature.SetField("LC_RD_AS", currentAttList.getAttribute("LC_RD_AS"))
        feature.SetField("LC_RD_DG", currentAttList.getAttribute("LC_RD_DG"))
        feature.SetField("LC_RD_CO", currentAttList.getAttribute("LC_RD_CO"))
        feature.SetField("LC_RD_IG", currentAttList.getAttribute("LC_RD_IG"))
        ...
        feature.SetField("LC_RES_IG", currentAttList.getAttribute("LC_RES_IG"))
        feature.SetField("LC_RES_DG", currentAttList.getAttribute("LC_RES_DG"))
        feature.SetField("LC_RES_CO", currentAttList.getAttribute("LC_RES_CO"))
        feature.SetField("LC_RES_RF", currentAttList.getAttribute("LC_RES_RF"))
        feature.SetField("LC_RES_AS", currentAttList.getAttribute("LC_RES_AS"))
        feature.SetField("LC_RES_TR", currentAttList.getAttribute("LC_RES_TR"))
        ...
        feature.SetField("LC_LI_IG", currentAttList.getAttribute("LC_LI_IG"))
        feature.SetField("LC_LI_DG", currentAttList.getAttribute("LC_LI_DG"))
        feature.SetField("LC_LI_CO", currentAttList.getAttribute("LC_LI_CO"))
        feature.SetField("LC_LI_RF", currentAttList.getAttribute("LC_LI_RF"))
        feature.SetField("LC_LI_AS", currentAttList.getAttribute("LC_LI_AS"))
        feature.SetField("LC_LI_TR", currentAttList.getAttribute("LC_LI_TR"))
        ...
        feature.SetField("LC_HI_IG", currentAttList.getAttribute("LC_HI_IG"))
        feature.SetField("LC_HI_DG", currentAttList.getAttribute("LC_HI_DG"))
        feature.SetField("LC_HI_CO", currentAttList.getAttribute("LC_HI_CO"))
        feature.SetField("LC_HI_RF", currentAttList.getAttribute("LC_HI_RF"))
        feature.SetField("LC_HI_AS", currentAttList.getAttribute("LC_HI_AS"))
        feature.SetField("LC_HI_TR", currentAttList.getAttribute("LC_HI_TR"))
        ...
        feature.SetField("LC_COM_IG", currentAttList.getAttribute("LC_COM_IG"))
        feature.SetField("LC_COM_DG", currentAttList.getAttribute("LC_COM_DG"))
        feature.SetField("LC_COM_CO", currentAttList.getAttribute("LC_COM_CO"))
        feature.SetField("LC_COM_RF", currentAttList.getAttribute("LC_COM_RF"))
        feature.SetField("LC_COM_AS", currentAttList.getAttribute("LC_COM_AS"))
        feature.SetField("LC_COM_TR", currentAttList.getAttribute("LC_COM_TR"))
        ...
        feature.SetField("LC_ORC_IG", currentAttList.getAttribute("LC_ORC_IG"))
        feature.SetField("LC_ORC_DG", currentAttList.getAttribute("LC_ORC_DG"))
        feature.SetField("LC_ORC_CO", currentAttList.getAttribute("LC_ORC_CO"))
        feature.SetField("LC_ORC_RF", currentAttList.getAttribute("LC_ORC_RF"))
        feature.SetField("LC_ORC_AS", currentAttList.getAttribute("LC_ORC_AS"))
        feature.SetField("LC_ORC_TR", currentAttList.getAttribute("LC_ORC_TR"))
        ...
        if tech_incl == 1:
            ...
            feature.SetField("wd_RES_I", currentAttList.getAttribute("wd_RES_I"))
            ...
            feature.SetField("wd_HDR_I", currentAttList.getAttribute("wd_HDR_I"))
...
def exportPlannedWSUD(filename, assets, miscoptions, map_attr, kmlbool):
    ...
    for i in range(int(strategies)):
        ...
        fielddefmatrix.append(ogr.FieldDefn("StoreVol", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("StoreType", ogr.OFTString))
        fielddefmatrix.append(ogr.FieldDefn("IntegStore", ogr.OFTInteger))
        fielddefmatrix.append(ogr.FieldDefn("Status", ogr.OFTInteger))
        fielddefmatrix.append(ogr.FieldDefn("Year", ogr.OFTInteger))
        fielddefmatrix.append(ogr.FieldDefn("EAFact", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("SvWQ_ImpT", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("SvQty_ImpT", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("SvRec_Supp", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("CurImpTWQ", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("CurImpTQty", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("CurSupply", ogr.OFTReal))
        fielddefmatrix.append(ogr.FieldDefn("SupplyRel", ogr.OFTReal))
        ...
        for i in range(len(assets)):
            ...
            feature.SetField("StoreVol", currentAttList.getAttribute("StoreVol"))
            feature.SetField("StoreType", currentAttList.getAttribute("StoreType"))
            feature.SetField("IntegStore", currentAttList.getAttribute("IntegStore"))
            feature.SetField("Status", int(currentAttList.getAttribute("Status")))
            feature.SetField("Year", int(currentAttList.getAttribute("Year")))
            feature.SetField("EAFact", currentAttList.getAttribute("EAFact"))
            feature.SetField("SvWQ_ImpT", currentAttList.getAttribute("SvWQ_ImpT"))
            feature.SetField("SvQty_ImpT", currentAttList.getAttribute("SvQty_ImpT"))
            feature.SetField("SvRec_Supp", currentAttList.getAttribute("SvRec_Supp"))
            feature.SetField("CurImpTWQ", currentAttList.getAttribute("CurImpTWQ"))
            feature.SetField("CurImpTQty", currentAttList.getAttribute("CurImpTQty"))
            feature.SetField("CurSupply", currentAttList.getAttribute("CurSupply"))
            feature.SetField("SupplyRel", currentAttList.getAttribute("SupplyRel"))
